...
<nav>
	{#if $sessionIdentity}
		<button type="button" class="nav-action session-shorthand scope-viewer mr-auto" title="Information about your PeerLens session" onclick={openSessionInfoModal}>
			<svg class="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="currentColor" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
