...
<div class="page">
  <div class="card">
    <section class="ipv6-hero mb-7">
      ...
      <div class="ipv6-visual" aria-hidden="true">
	...
	<section class="card">
		...
		<div class="subtle-card">
			<div>
				...
				<p>
					Your browser builds a list of possible network paths (ICE candidates). One of these can be your global
					IPv6 address.
				</p>
			</div>
		</div>
		...
		<div class="subtle-card">
			<div>
				...
				<p class="mb-0">
					After negotiation, your video stream goes directly from phone to viewer. The PeerLens server is not part
					of the media path.
				</p>
			</div>
		</div>
